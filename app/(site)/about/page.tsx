...
const aboutEngineeredDurabilityImages: Array<{
...
}> = [
  {
    ...
    alt:
      'Inside a professional woodworking facility with advanced machines, stacked panels, and team members at work.',
    width: 684,
    height: 424
  },
  {
    ...
    alt:
      'A large-scale automated CNC or panel machine with an overhead dust-collection system on a factory floor.',
    width: 678,
    height: 454
  },
  {
    ...
    alt:
      'Spacious manufacturing floor with heavy machinery, yellow overhead crane beam, and red structural steel.',
    width: 682,
    height: 600
  },
  {
    ...
    alt:
      'A HOMAG industrial machine processing wood panels, surrounded by wire safety fencing, in a clean warehouse.',
    width: 660,
    height: 422
  },
  {
    ...
    alt:
      'CNC woodworking center in operation, with a control console, vacuum hoses, and team members on the production floor.',
    width: 656,
    height: 460
  }
]

/** First two: paired with "Manufacturing advantage" — last three: "Engineered for durability" */
const aboutManufacturingAdvantageImages = aboutEngineeredDurabilityImages.slice(0, 2)
const aboutEngineeredDurabilityOnlyImages = aboutEngineeredDurabilityImages.slice(2)
...
const aboutExecutionImages: Array<{
...
}> = [
  {
    ...
    alt:
      'Warehouse floor with rows of strapped, shrink-wrapped flat packs on pallets, loading bay door, and high-angle industrial view.',
    width: 912,
    height: 454
  },
  {
    ...
    alt:
      'Organized distribution warehouse with blue pallet racks, stacked inventory, and yellow safety lines on a concrete floor.',
    width: 926,
    height: 432
  }
]
...
function BulletList ({ items, className }: { items: string[]; className?: string }) {
  return (
    <ul className={`list-disc space-y-3 pl-5 text-sm leading-[1.75] text-foreground/88 sm:text-base ${className || ''}`}>
      {items.map((t) => (
        <li key={t}>
          {t}
        </li>
  ...
  return (
    <main id="main-content" className="flex-1">
      ...
      <div className="bg-tile-section-wash">
        <div className="container max-w-4xl space-y-20 py-20 md:space-y-24 md:py-28">
        <FadeIn>
          <p className="text-base leading-[1.8] text-muted-foreground sm:text-lg">
            With over 40 years of experience, Shioleno Industries delivers high-quality, engineered
            casework and millwork solutions — designed to keep projects on time and on budget.
          </p>
          <p className="mt-6 text-base leading-[1.8] text-muted-foreground sm:text-lg">
            Shioleno Industries is a precision-focused manufacturing partner specializing in
            custom casework, millwork and fixtures for hospitality, commercial retail/trade and
            healthcare environments.
          </p>
          <p className="mt-6 text-base leading-[1.8] text-muted-foreground sm:text-lg">
            With decades of experience, we combine engineering expertise, advanced production
            capabilities, and scalable operations to deliver consistent, high-quality results —
          ...
          <div className="grid gap-8 md:grid-cols-[minmax(0,240px)_1fr] md:items-start md:gap-10 lg:grid-cols-[minmax(0,280px)_1fr] lg:gap-12">
            <FadeIn>
              <figure className="mx-auto w-full max-w-sm lg:mx-0 lg:max-w-none">
                <div className="relative aspect-[560/532] w-full overflow-hidden rounded-xl border border-border/15 bg-muted/15 shadow-sm">
                  <Image
        ...
        <section
          ...
          className="space-y-6 border-t border-border/20 pt-16 md:space-y-8 md:pt-20"
        >
          <FadeIn>
            <SectionHeading
              as="h2"
        ...
        <section aria-labelledby="engineered-durability" className="space-y-6">
          <FadeIn>
            <SectionHeading
              as="h2"
        ...
        <section aria-labelledby="what-you-can-expect" className="space-y-6">
          <FadeIn>
            <SectionHeading
              as="h2"
          ...
          <FadeIn className="mt-2" delayMs={50}>
        ...
        <section aria-labelledby="execution">
          <div className="grid gap-8 md:grid-cols-[minmax(0,320px)_1fr] md:items-start md:gap-10 lg:grid-cols-[minmax(0,360px)_1fr] lg:gap-12">
            <FadeIn>
              <ul className="list-none space-y-3 p-0 sm:space-y-4" role="list">
        ...
        <section aria-labelledby="one-partner" className="space-y-8">
          ...
          <div className="grid gap-8 sm:grid-cols-3">
            <FadeIn>
              ...
              <ul className="mt-3 list-disc space-y-2 pl-5 text-foreground/90" role="list">
        ...
        <FadeIn>
          <CTASection title="Start a project conversation" href="/contact" buttonText="Contact us" />
        </FadeIn>
        </div>
      </div>
    </main>
